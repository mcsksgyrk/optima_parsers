...
xml_dir = '/home/nvme/Opt/5_Bence/xml'
output_directory = xml_dir + '/delle2014/suppl'
...
for i in range(1, 10001):
    file_index = i
    generate_file(file_index, output_directory, species, bounds, data, sigmas_non_scaled)
